...
public class BRulesTest {
	...
	public void testIsJSONNull() {
		boolean b = BRules.isJSON(null);
		assertFalse(b);
	}
	
	@Test
	public void testIsJSONEmptyString() {
		boolean b = BRules.isJSON("");
		assertFalse(b);
	}
	...
	public void testIsJSONSimple() {
		boolean b = BRules.isJSON("{name: \"Carl\"}");
		assertTrue(b);
	}
	
	@Test
	public void testIsJSONArray() {
		boolean b = BRules.isJSON("['BRules 1', 'BRules2']");
		assertTrue(b);
	}

	@Test
	public void testIsJSONNested() {
		boolean b = BRules.isJSON("{ [{\"name\": \"Carl\"}, {\"program\": \"BRules\"}] }");
		assertTrue(b);
	}
	...
	public void hasJSONPathNull() throws Exception {
		...
		boolean b = BRules.hasJSONPath(json, jsonPath);
		assertFalse(b);
	}
	...
	public void hasJSONPathNullPath() throws Exception {
		...
		BRules.hasJSONPath(json, jsonPath);
	}
	...
	public void hasJSONHasSingle() throws Exception {
		...
		assertTrue(b);
		json = "{\"name\":\"carl\"}";
		b = BRules.hasJSONPath(json, jsonPath);
		assertTrue(b);
	}
